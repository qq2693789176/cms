...
public class Page {
	...
	public static void fenye(Model model, PageInfo info,String url) {
		...
		String fenye = "当前是" + info.getPageNum() + "/" + info.getPages() + "页--共" + info.getTotal()
				+ "条数据&nbsp;&nbsp;<a href='list.do?pageNum=1"+url+"'>首页</a>&nbsp;&nbsp;<a href='list.do?pageNum=" + info.getPrePage()
				+ ""+url+"'>上一页</a> &nbsp;&nbsp;<a href='list.do?pageNum=" + info.getNextPage()
				+ ""+url+"'>下一页</a> &nbsp;&nbsp;<a href='list.do?pageNum=" + info.getPages()
				+ ""+url+"'>尾页</a>";
